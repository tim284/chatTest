...
class CrdtFactoryImpl {
    ...
    integer(key) {
        return new CrdtIntegerImpl(this, key, this.getBucket(), 7 /* INTEGER */);
    }
    ...
    map(key) {
        return new CrdtMapImpl(this, key, this.getBucket(), 9 /* AWMAP */);
    }
...
class ConnectionImpl extends CrdtFactoryImpl {
    ...
    startTransaction() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resp = yield this.connection.sendRequest(messageCodes_1.MessageCodes.apbStartTransaction, encode(message));
            if (resp.success) {
    ...
    readBatch(objects) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resp = yield this.connection.sendRequest(messageCodes_1.MessageCodes.apbStaticReadObjects, encode(message));
            let cr = yield this.completeTransaction(resp.committime);
    ...
    update(updates) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resp = yield this.connection.sendRequest(messageCodes_1.MessageCodes.apbStaticUpdateObjects, encode(message));
...
class TransactionImpl extends CrdtFactoryImpl {
    ...
    readBatch(objects) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resp = yield this.antidoteConnection.sendRequest(messageCodes_1.MessageCodes.apbReadObjects, encode(message));
            if (resp.success) {
                let resVals = [];
                for (let i in objects2) {
                    var obj = objects2[i];
    ...
    update(updates) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.antidoteConnection.sendRequest(messageCodes_1.MessageCodes.apbUpdateObjects, encode(message));
        });
    }
    commit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resp = yield this.antidoteConnection.sendRequest(messageCodes_1.MessageCodes.apbCommitTransaction, encode(message));
...
class CrdtIntegerImpl extends AntidoteObjectImpl {
    interpretReadResponse(readResponse) {
...
class CrdtMapValueImpl {
    ...
    integerValue(key) {
        return this.get(key, 7 /* INTEGER */);
    }
    gmapValue(key) {
        return this.get(key, 8 /* GMAP */);
    }
    awmapValue(key) {
        return this.get(key, 9 /* AWMAP */);
    }
    rwsetValue(key) {

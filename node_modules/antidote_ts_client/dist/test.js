...
describe("antidote client", function () {
    ...
    describe('integers', () => {
        it('can be incremented and assigned to', () => __awaiter(this, void 0, void 0, function* () {
            let num = connection.integer("myint");
            yield connection.update(num.set(40));
            yield connection.update(num.increment(2));
            let val = yield num.read();
            assert.equal(val, 42);
        }));
    });
